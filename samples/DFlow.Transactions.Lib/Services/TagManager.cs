...
//
//  Created on     : 04-jun-2017 11:34:39
...
namespace DFlow.Transactions.Lib.Services
{
    public class TagManager : BaseRepository<Tag, int>, IEntityManager<Tag, int>, ITagManager
    {
        ...
        protected override IEnumerable<ValidationResult> ValidateDelete(Tag entity)
        {
            yield break;
        }

        protected override IEnumerable<ValidationResult> ValidateSave(Tag entity)
        {
